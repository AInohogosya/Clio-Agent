...
class IconProvider:
    """Provides QIcons from inline SVG data."""

    ICON_SIZE = 24

    # ── SVG Icon Data ────────────────────────────────────────────
    SVGS = {
        "app_logo": """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <defs>
            ...
            <path d="M256 100 L280 200 L384 212 L296 268 L316 372 L256 312 L196 372 L216 268 L128 212 L232 200 Z" fill="white" opacity="0.95"/>
            <circle cx="256" cy="256" r="40" fill="white" opacity="0.3"/>
        </svg>""",

        "chat": """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        "ollama": """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            <path d="M12 2a8 8 0 0 0-8 8c0 3.5 2.3 6.4 5.5 7.5L8 22l2-1.5 2 1.5-1.5-4.5A8 8 0 0 0 20 10a8 8 0 0 0-8-8z"/>
        ...
        "alert": """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        "bot": """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <rect x="3" y="8" width="18" height="12" rx="2"/><circle cx="12" cy="5" r="2"/><path d="M12 7v2"/><line x1="8" y1="14" x2="8" y2="14"/><line x1="16" y1="14" x2="16" y2="14"/><line x1="9" y1="18" x2="15" y2="18"/>
        </svg>""",
        ...
        "skip_forward": """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <polygon points="5 4 15 12 5 20 5 4"/><line x1="19" y1="5" x2="19" y2="19"/>
        </svg>""",

        "hash": """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        "spinner": """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
            <path d="M12 2v4"/><path d="M12 18v4"/><path d="M4.93 4.93l2.83 2.83"/><path d="M16.24 16.24l2.83 2.83"/><path d="M2 12h4"/><path d="M18 12h4"/><path d="M4.93 19.07l2.83-2.83"/><path d="M16.24 7.76l2.83-2.83" opacity="0.3"/>
        </svg>""",
    }

    @classmethod
    def get_icon(cls, name, size=None, color=None):
        """Get a QIcon by name, optionally with custom size and color."""
        size = size or cls.ICON_SIZE
        svg_data = cls.SVGS.get(name, cls.SVGS.get("info"))
    ...
    @classmethod
    def get_pixmap(cls, name, size=None, color=None):
        """Get a QPixmap by name."""
        size = size or cls.ICON_SIZE
        svg_data = cls.SVGS.get(name, cls.SVGS.get("info"))
