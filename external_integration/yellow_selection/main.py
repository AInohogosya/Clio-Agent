...
try:
    ...
    from .clean_hierarchical_selector import (
        get_clean_selector,
...
def get_yellow_menu(
    title: str, description: str, use_fallback: bool = False
) -> CleanInteractiveMenu:
...
def create_provider_menu() -> CleanInteractiveMenu:
    ...
    return get_yellow_menu(
        "Select AI Provider", "Choose how you want to run AI models:"
    )


def create_model_menu() -> CleanInteractiveMenu:
    """Create a model selection menu with yellow highlighting"""
    return get_yellow_menu("Select Model", "Choose your preferred AI model:")
