...
class StructuredLogFormatter(logging.Formatter):
    ...
    Output format:
    {
        ...
        "source": {
            "file": "autonomous_loop_engine.py",
            "line": 123,
    ...
    def __init__(
        ...
        if json_output and log_dir:
            ...
            standard_handler = RotatingFileHandler(
                standard_file, maxBytes=max_file_size, backupCount=backup_count
            )
...
class TelemetryCollector:
    ...
    def reset(self):
        """Reset all metrics"""
        self.metrics = {"counters": {}, "gauges": {}, "histograms": {}}
...
def configure_logging(
    level: str = "INFO", json_output: bool = True, log_dir: Optional[str] = None
):
    """
    ...
    logger = get_structured_logger(
        name="clio_agent", log_level=log_level, log_dir=log_dir, json_output=json_output
    )
...
def log_execution_metric(
    ...
    labels = {"provider": provider, "model": model, "phase": phase or "unknown"}
